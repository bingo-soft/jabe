...
abstract class ProcessEngines
{
    ...
    protected static $processEngines = [];
    protected static $processEngineInfosByName = [];
    protected static $processEngineInfosByResourceUrl = [];
     ...
     */
    public static function registerProcessEngine(ProcessEngineInterface $processEngine): void
    {
        self::$processEngines[$processEngine->getName()] = $processEngine;
    }
