...
use Jabe\Model\Knd\ConstructionSupervision\Instance\Request\OrderStatusCodeInterface;

class OrderStatusCodeImpl extends ModelElementInstanceImpl implements OrderStatusCodeInterface
{
    public static function registerType(ModelBuilder $modelBuilder): void
    {
        ...
        ->instanceProvider(
            ...
            {
                public function newInstance(ModelTypeInstanceContext $instanceContext): OrderStatusCodeInterface
                {
                    return new OrderStatusCodeImpl($instanceContext);
                }
            }
        );
