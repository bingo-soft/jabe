...
use Jabe\Variable\Type\SerializableValueTypeInterface;
...
abstract class AbstractSerializableValueSerializer extends AbstractTypedValueSerializer
{
    ...
    public function writeValue($value, ValueFieldsInterface $valueFields): void
    {
        ...
        if ($value->isDeserialized()) {
            ...
            if ($serializedStringValue !== null) {
                $serializedByteValue = $serializedStringValue;
            }
        }
    ...
    public function readValue(ValueFieldsInterface $valueFields, bool $deserializeValue, bool $isTransient = false): SerializableValueInterface
    {
