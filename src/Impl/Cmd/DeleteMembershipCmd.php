...
class DeleteMembershipCmd extends AbstractWritableIdentityServiceCmd implements CommandInterface, \Serializable
{
    private $userId;
    private $groupId;
    ...
    protected function executeCmd(CommandContext $commandContext)
    {
        ...
        $operationResult = $commandContext
            ...
            ->deleteMembership($this->userId, $this->groupId);
