...
class AnimalCreateModelTest extends TestModelTest
{
    protected $tweety;
    protected $hedwig;
    protected $birdo;
    ...
    protected $timmy;
    protected $daisy;
    protected $hedwigRelationship;
    protected $birdoRelationship;
    protected $pluckyRelationship;
    protected $fiffyRelationship;
    protected $timmyRelationship;
    protected $daisyRelationship;
    ...
    public function testChangeIdAttributeOfMotherReference(): void
    {
        $this->tweety->setMother($this->daisy);
        $this->assertTrue($this->tweety->getMother()->equals($this->daisy));
